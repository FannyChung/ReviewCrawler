...
public class Controler {
	...
	public static void main(String[] args) throws Exception {
		...
		String s=search.search("http://www.amazon.cn/ref=nav_logo", "相机");//设置主页和搜索内容
		HashSet<ProductUrl> productsStrings=search.getProductPage(s);//获取搜索后得到的所有商品url
		ProductReview crawler = new ProductReview(".product");//爬取所有的商品
		crawler.setThreads(1);
		crawler.setResumable(false);
		int i=0;
		final int productNum=5;//设置爬取商品的个数
